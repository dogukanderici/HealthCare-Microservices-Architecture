...
{
    public class GetProcessDefinitionCountQueryHandler : IRequestHandler<GetProcessDefinitionCountQuery, GetProcessDefinitionCountQueryResult>
    {
        ...
        public async Task<GetProcessDefinitionCountQueryResult> Handle(GetProcessDefinitionCountQuery request, CancellationToken cancellationToken)
        {
            ...
            return _mapper.Map<GetProcessDefinitionCountQueryResult>(result);
        }
    }
}