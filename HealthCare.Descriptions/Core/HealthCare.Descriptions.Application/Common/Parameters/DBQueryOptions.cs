...
namespace HealthCare.Descriptions.Application.Common.Parameters
{
        ...
        where TEntity : class
    {
        ...
        public Dictionary<Expression<Func<TEntity,object>>, List<Expression<Func<TEntity, object>>>> thenOrderBy { get; set; } = null;
        public int sortingType { get; set; } = (int)SortDirection.Descending;
        public int thenBySortingType { get; set; } = (int)SortDirection.Descending;
