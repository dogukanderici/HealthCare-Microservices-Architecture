...
{
    public class HospitalPoliclinicQuotaUpdateCommandValidator : AbstractValidator<UpdateHospitalPoliclinicQuotaCommand>
    {
        public HospitalPoliclinicQuotaUpdateCommandValidator()
        {
