...
{
    public class UpdateBillingServicesCommand : IRequest
    {
        public List<UpdateBillingServiceProperty> UpdateListData { get; set; }
    }

    public class UpdateBillingServiceProperty : GenericAuditCommand
    {
