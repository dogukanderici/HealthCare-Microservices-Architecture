...
{
    public class CreateBillingServicesCommand : IRequest<GenericHandlerResponse>
    {
        public List<CreateBillingServiceProperty> CreateListData { get; set; }
    }

    public class CreateBillingServiceProperty : GenericAuditCommand
    {
